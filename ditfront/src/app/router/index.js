...
import Showcase from '@/packages/discovery/pages/ShowcasePage.vue';
...
const routes = [
  ...
  { path: '/featured', component: Showcase, meta: { hideComposer: true } },
  { path: '/showcase', component: Showcase, meta: { hideComposer: true } },
  { path: '/my-content', component: MyContent, meta: { hideWorkspace: true } },
  { path: '/settings', component: Settings },
  { path: '/viewer/:imageName?', component: Viewer },
